    ...
    <section className="py-10 md:py-[78px] h-full">
      <div className="max-w-[1280px] w-full px-4 md:px-6 mx-auto max-xl:text-center xl:flex xl:items-center xl:justify-between xl:gap-10">
        <div className="flex flex-col gap-6 mb-10 md:mb-16 items-center justify-between">
          ...
          <button
            type="button"
            className="text-white border bg-brand-green rounded-[30px] text-lg font-medium px-6 py-3 md:px-[50px] md:py-[18px] mt-4 md:mt-10 hover:bg-brand-green-hover transition duration-300 ease-in-out"
          >
            <Link
              href="/psychologists"
        ...
        <div className="relative mx-auto w-fit">
          <MdOutlineQuestionMark
            size={10}
            className="bg-brand-purple rounded-[10px] text-brand-white w-10 h-10 p-3 rotate-[-15deg] absolute top-28 md:top-52 left-0 md:-left-8"
          />
          <UsersRound
            size={10}
            className="bg-brand-orange rounded-[10px] text-brand-white w-11 h-11 p-3 rotate-[15deg] absolute top-8 right-0 md:-right-8"
          />
          <div className="bg-brand-green flex rounded-[20px] p-4 md:p-8 text-left gap-4 absolute -bottom-10 left-1 md:-left-24 md:bottom-16">
            <Check
              size={30}
